...
bool Collision::item_santa(Object obj1, Object obj2, float bufferX, float bufferY)
{
    float coord1 = 0.0f, coord2 = 0.0f;
...
bool Collision::enemy_santa(Object obj1, Object obj2, float bufferX, float bufferY)
{
    float coord1 = 0.0f, coord2 = 0.0f;
    /*float buffer = 50.0f;*/  // 特定のオブジェクトの当たり判定を縮小するためのバッファ
...
bool Collision::block_santa(Object obj1, Object obj2, float bufferX, float bufferY)
{
    float coord1 = 0.0f, coord2 = 0.0f;
    /*float buffer = 50.0f;*/  // 特定のオブジェクトの当たり判定を縮小するためのバッファ
